...
def evaluasi_postur_lengkap(
    ...
    # Penalti bahu miring jika > 0.05
    penalti_bahu = max(0.0, (level_bahu - 0.02) * 200.0) if level_bahu > 0.02 else 0.0

    # Bobot skor: 55% leher, 35% punggung, 10% bahu
    skor_total = (skor_leher * 0.55) + (skor_punggung * 0.35) - min(penalti_bahu, 15.0)
